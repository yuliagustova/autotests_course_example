...
def everything_for_your_cat(cats_data):
    """
    На вход принимает кортеж из 4 значений. На основе данных из кортежа создаем строку в формате:
    Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    :param cats_data: кортеж из 4 значений (с кличкой, возрастом котика и именем, фамилией хозяина)
    :return: строка с именем и фамилией хозяина и информации об его кошках (кличка, возраст)
    """
    our_str = ''
    cats_dict = {}
