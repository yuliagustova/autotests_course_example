...
def global_function():
    """
    Присваиваем локальной переменной msg значение 1 и через вызов вложенной функции local_function
    меняем значение переменной msg на 2 и возвращаем новое значение
    :return: значение локальной переменной msg
    """
    msg = 1

    def local_function():
        """
        Меняем значение переменной msg на 2
        """
        nonlocal msg
        msg = 2
