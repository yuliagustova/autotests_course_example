...
def letter_stat(our_str):
    """
    На вход подается строка our_str. Подсчитываем, сколько раз каждая буква встречалась в слове
    :param our_str: строка со словом, в котором необходимо посчитать количество каждой буквы
    :return: словарь, где ключ - буква, значение - сколько раз она встречалась в слове
    """
    letters_dict = {}
