...
def scrabble(word):
    """
    На вход подается строка word. Подсчитываем в данной строке количество очков за символ (каждый символ - определенное
    количество очков)
    :param word: строка со словом, в котором необходимо посчитать количество очков за каждую букву в нем
    :return: число, соответсвующее общему количеству очков за все буквы в переданном слове
    """
    cost = {1: 'авеёинорст',
            2: 'дклмпу',
            3: 'бгья',
